function calcular(){
    ...
    if(qtd < 3){
        res.innerHTML = `<br><p>Você não está se hidratando direitinho!<br> É preciso pelo menos <strong> 3 lts</strong> de água por dia <br><br>Gabriel não vai ficar orgulhoso de você</p>`
    }
}